(*
Borrowed/tweaked from here:

https://github.com/DistributedComponents/verdi-lockserv/blob/master/systems/LockServ.v
...
Definition init_data (t:AnnoTerm) (e:EvidenceC) (n : Name) : Data :=
  ...
  - eauto using LockServ_nwnw_net_handlers_new_new.
            ...
            Locate true_in_reachable.

            Locate step_async_init.
            Locate inductive_invariant_true_in_reachable.
            Locate decomposition_invariant.
