...
Definition rodeo_terms_noargs_map := 
  [
    ...
    ("micro_provision_dir_1_noargs", micro_appTerm_provision_dir_1);
    ("micro_provision_dir_2_noargs", micro_appTerm_provision_dir_2);
    ("micro_provision_composite_noargs", micro_appTerm_provision_composite);
    ("run_coq_thm_noargs", run_command_asp_coq);
    ("run_coq_test_noargs", run_command_asp_coq_test);
    ("run_coq_all_noargs", meas_theorem);
    ("run_coq_all_appr_noargs", meas_theorem_appr);
    ("coq_env_dir_provision_noargs", coq_env_provision_dir);
    ("coq_provision_all_noargs", coq_appTerm_provision)
  ].
Close Scope string_scope.