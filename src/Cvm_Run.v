...
Definition run_cvm_w_config (t:Term) (e:RawEv) (ac : AM_Config) : cvm_st :=
  run_cvm' t (mk_st (evc e mt) [] 0 ac).

Definition run_cvm_rawEv (t:Term) (e:RawEv) (ac : AM_Config) : RawEv :=
  get_bits (st_ev (run_cvm_w_config t e ac)).
