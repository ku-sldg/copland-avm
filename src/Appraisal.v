...
Proof.
  ...
  - (* aatt case *)
    ...
    assert (not_hash_sig_term_ev t e).
    {
      ...
      destruct_conjs.
      subst.
      unfold not_hash_sig_term in H4.
      unfold not in H4.
      eapply H4 with (t':=(alseq (n2, n3) H8 H6)).
      econstructor.
      repeat eexists.
      eassumption.
      eassumption.
  ...
  -
    ...
    assert (not_hash_sig_term t2).
    {
      ...
      intros.
      destruct_conjs.
      eapply H0 with (t':= (alseq (n, n0) H13 H11)).
      econstructor.
      repeat eexists.
      eassumption.
      eassumption.
    ...
    assert (not_hash_sig_term_ev t2 H5).
    {
      split.
      eassumption.
      split.
...
(*
      ...
      unfold not_hash_sig_term in H9.
      unfold not_hash_sig_ev in H8.
      unfold gg_sub.
      unfold not_hash_sig_term_ev in H7.
      destruct_conjs.
      unfold not_hash_sig_term_ev in H0.
      destruct_conjs.
      unfold not_hash_sig_term in H0.
      ...
      unfold not in H13.
      unfold not in H11.
      unfold not_hash_sig_term in H7.
      cbv in H0.
      unfold not.
      intros.
      destruct_conjs.
  ...
  -
    ...
    +
      assert (not_hash_sig_ev e4).
      {
        ...
        3: {
          eassumption. }
        assert (not_hash_sig_term_ev t1 (splitEvl s e)).
        {
          destruct ecc.
    ...
    +
      assert (not_hash_sig_ev e5).
      {
        ...
        3: {
          eassumption. }
        assert (not_hash_sig_term_ev t2 (splitEvr s e)).
        {
           destruct ecc.
