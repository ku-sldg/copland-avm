...
Require Import Term_Defs ConcreteEvidence StMonad_Coq IO_Type Manifest.
...
Definition am_sendReq (t:Term) (pFrom:Plc) (pTo:Plc) (authTok:ReqAuthTok) (e:RawEv) (aspCb : CakeML_ASPCallback) (pubKeyCb : CakeML_PubKeyCallback) (plcCb : CakeML_PlcCallback) : RawEv.
Admitted.
