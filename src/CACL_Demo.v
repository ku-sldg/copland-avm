...
Definition query_kim_args : ASP_ARGS := 
    JSON_Object [(query_kim_dynammic_arg_id, (JSON_String query_kim_dynammic_arg_val));
     (query_kim_appraisal_dir_arg_id, (JSON_String query_kim_appraisal_dir_arg_val))].
