...
(* A system's privacy policy maps each Place to the list of Components on the system that it is prepared to release measurements of (in the clear) to that Place.  This allows a system to disclose more/lesplit_evt configuration information to each place based on its current trust relationship with that Place. *)
