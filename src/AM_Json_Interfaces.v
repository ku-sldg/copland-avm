...
Definition do_appraisal_session (appreq:ProtocolAppraiseRequest) (m : Manifest) (aspBin : FS_Location) (nonceVal:BS)
  ...
  let sess_config := (session_config_compiler m aspBin att_sess) in
...
Definition handle_AM_request_JSON (js : JSON) (m : Manifest) (aspBin : FS_Location) (nonceVal:BS) 
    : JSON :=
  ...
  | resultC req_type =>
    ...
    then (
      ...
      | resultC r =>
        ...
        let sc := (session_config_compiler m aspBin att_sess) in
    ...
    then (
      ...
      | errC msg => ErrorResponseJSON msg
      | resultC appreq =>
        let app_resp := (do_appraisal_session appreq m aspBin nonceVal) in 
        match app_resp with
        | errC e => ErrorResponseJSON e
