...
Definition check_asp_EXTD (params:ASP_PARAMS) (p:Plc) (ls:RawEv) (ac : AM_Config) : ResultT BS DispatcherErrors :=
  ac.(app_aspCb) params p ls.

Definition check_asp_EXTD' (params:ASP_PARAMS) (p:Plc) (ls:RawEv) : AM BS :=
  ac <- get_AM_amConfig ;;
  match (check_asp_EXTD params p ls ac) with
  | resultC r => ret r
