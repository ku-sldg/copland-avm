...
(*
Inductive EvSubTAspEnc: Evidence -> Evidence -> ASP_ID -> Plc -> Prop :=
(* | evsub_reflT_enc : forall (e : Evidence) q, EvSubTEnc e e q *)
| uuSubT_asp_enc: forall e e' p q ps i,
    EvSubTAspEnc e e' i q -> 
    get_targ_plc ps = q -> 
    EvSubTAspEnc e (uu p ENCR ps e') i q
| uuSubT_asp_noenc_sub: forall e e' p q fwd ps i,
    EvSubTAspEnc e e' i q -> 
    fwd <> ENCR -> 
    EvSubTAspEnc e (uu p fwd ps e') i q
| uuSubT_asp_noenc: forall e e' p q ps i fwd,
    EvSubTAspEnc e e' i q -> 
    get_asp_id ps = i -> 
    fwd <> ENCR ->
    EvSubTAspEnc e (uu p fwd ps e') i q
| ssSublT: forall e e' e'' q i,
    EvSubTAspEnc e e' i q ->
    EvSubTAspEnc e (ss e' e'') i q
| ssSubrT: forall e e' e'' q i,
    EvSubTAspEnc e e'' i q ->
    EvSubTAspEnc e (ss e' e'') i q.
#[export] Hint Constructors EvSubTAspEnc : core.
